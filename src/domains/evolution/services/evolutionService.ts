...
import { MutationCategory } from '../../../shared/types/core';
...
export class EvolutionService {
  ...
  // Configuration values that can be used in future implementations
   ...
   */
  initialize(blockData: BlockData, mutationService: any): void {
  ...
  evolveCreature(creature: Creature): EvolutionResult {
    ...
    const result: EvolutionResult = {
      ...
      blockNumber: this.blockData.height || 0,
      confirmations,
